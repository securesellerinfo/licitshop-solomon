...
export default function Applebank() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Apple Bank Logs updated 23/12/2021</div>
              <div className="goodForCC">
                Apple Bank logs This Log is Good for CC Top and wire
              </div>
              <div>
