...
export default function Amexcards() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">AMAX</div>
              <div className="goodForCC">
                AMAX USA Good for online shopping and Bills pay all cards are
                valid and with a balance| UPDATED 21-12-2021
              </div>
              <div>
