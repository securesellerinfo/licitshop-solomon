...
export default function Keybanklogs() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Keybank Bank </div>
              <div className="goodForCC">
                Keybank Bank logs This Log is Good for CC Top and wire Zelle On
              </div>
              <div>
