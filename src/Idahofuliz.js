...
export default function Idahofuliz() {
  ...
  return (
    <div>
      ...
      >
        <div className="row">
          <header className="header-content">
            <div className="imgHam">
              <img className="coinbaseLogo" src="/logs.png" alt="headerLogos" />
              <span
        ...
        <div className="row">
          <div
            className="accordion accordion_menu col-md-2"
            id="accordionExample"
            style={{ width: accordionWidth ? "18%" : "0" }}
          >
            ...
            <div className="card">
              ...
              >
                <div className="card-body">
                  ...
                  <Link style={{ textDecoration: "none" }} to="/coinbase">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Idaho FULLZ</div>
              <div className="goodForCC">
                Idaho FULLZ Exclusive Fullz 100% Valid
              </div>
              <div>
