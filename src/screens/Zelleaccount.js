...
export default function Zelleaccount() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Zelle account</div>
              <div className="goodForCC">
                Zelle Acccount This Logs comes with Owners IP Address and
                Cookies. login is 100% Assured. all sales are Final
              </div>
              <div>
