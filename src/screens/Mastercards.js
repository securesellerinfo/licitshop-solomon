        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">MASTER CARD</div>
              <div className="goodForCC">
                MASTER CARD USA Good for online shopping and Bills pay all cards
