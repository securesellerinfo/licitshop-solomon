    ...
    <div>
      ...
      >
        ...
        <div className="row">
          <div
            className="addBalsmc"
            style={{ opacity: showDisplaysc2 ? "1" : "0" }}
          >
          ...
          <div
            ...
            style={{ opacity: showDisplaysc ? "1" : "0" }}
          >
            <div className="welcomeLem">Welcome : Lem</div>
            <div className="submitTicket">
              {" "}
            ...
            <div className="inner_div_table">
              ...
              <form>
                ...
                <select class="form-control" id="exampleFormControlSelect1">
                  <option>Please select the type of Ticket</option>
                  <option>Deposit issue</option>
                  <option>Tool issue</option>
                  <option>RDP selection issue</option>
                  <option>Request tools</option>
                  <option>Bank logs issues</option>
                  <option>Othe issues</option>
                </select>
                <label
                ...
                <button type="button" className="bg bg-primary sendTicket">
                  Send Ticket
                </button>
              </form>
            </div>
