...
export default function Shopwithscrip() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Shopwithscrip</div>
              <div className="goodForCC">
                Shopwithscrip Best for Giftcards 99.9% working all sales are
                Final. Only invalid logs can be replaced
              </div>
              <div>
