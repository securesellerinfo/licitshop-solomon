        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Blockchain USA Updated 23/12/2021</div>
              <div className="goodForCC">
                Blockchain USA Verified Blockchain Wallet With Random Balance
                all account are hacked and has a good transaction history all
                sales are Final!
              </div>
              <div>
