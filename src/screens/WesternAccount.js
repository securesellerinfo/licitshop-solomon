...
export default function WesternAccount() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated">Western union</div>
              <div className="goodForCC">
                Western union Western union transfers! make your purchase and
                email DarkWebLogs@14chains.com with your Order comfirmation
                Number
              </div>
              <div>
