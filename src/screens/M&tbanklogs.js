...
export default function Mandtbanklogs() {
        ...
        <div className="row">
          ...
          >
            <div className="inner_div_table">
              <div className="udpated"> M & T Bank</div>
              <div className="goodForCC">
                M&T Bank logs This Log is Good for CC Top and wire Zelle On
              </div>
              <div>
